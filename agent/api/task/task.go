...
func (task *Task) addNetworkResourceProvisioningDependencyServiceConnectBridge(cfg *config.Config) error {
	...
	for _, container := range task.Containers {
		...
		container.BuildContainerDependency(scPauseContainer.Name, apicontainerstatus.ContainerResourcesProvisioned, apicontainerstatus.ContainerResourcesProvisioned)
	}
	return nil
}
...
// TODO [SC] - how to let this handle bridge mode?
